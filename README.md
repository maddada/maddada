...
| Project | Description |
|---|---|
| [Ghostex](https://github.com/maddada/ghostex) • ⭐ 750 | <br />A Agentic IDE that combines Ghostty terminals with Codex App inspired UX macOS/Android/iOS. Fast and intuitive. Desktop/Browser use. Embedded Chromium browser. Agent Orchestration Skills. VS Code IDE Built-in. Auto sleep/resume. Auto naming. Much more.<br /><br /> |
